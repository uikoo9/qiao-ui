...
export const Toolbar = (props) => {
  colorLog('qiao-ui/components/toolbar: render');

  // search modal show
  const searchModalShow = () => {
    colorLog('qiao-ui/components/toolbar: searchModalShow');
  ...
  // edit modal show
  const editModalShow = () => {
    colorLog('qiao-ui/components/toolbar: editModalShow');
  ...
  // del rows
  const delRows = () => {
    colorLog('qiao-ui/components/toolbar: delRows');
  ...
  // first page
  const firstPage = () => {
    colorLog('qiao-ui/components/toolbar: firstPage');
  ...
  // prev page
  const prevPage = () => {
    colorLog('qiao-ui/components/toolbar: prevPage');
  ...
  // last page
  const lastPage = () => {
    colorLog('qiao-ui/components/toolbar: lastPage');
  ...
  // next page
  const nextPage = () => {
    colorLog('qiao-ui/components/toolbar: nextPage');
  ...
  const setPagesize = (pagesize) => {
    colorLog('qiao-ui/components/toolbar: setPagesize');
